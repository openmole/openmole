...
class CapsuleViewUI[T<: IGenericCapsule](scene: MoleScene, capsuleModel: ICapsuleModelUI[T], properties: Properties) extends Widget(scene) with ICapsuleView with IObjectViewUI{
