...
public aspect CachingAspect {
	...
	Object around(): execution(* *(..)) && @annotation(org.openmole.misc.caching.Cachable) {
	...
	Object around(): execution(* *(..)) && @annotation(org.openmole.misc.caching.SoftCachable) {
		Object object = thisJoinPoint.getThis();
		String method = thisJoinPoint.getSignature().toString();
        ...
        before() : execution(* *(..)) && @annotation(org.openmole.misc.caching.ChangeState) {
             Object object = thisJoinPoint.getThis();
             objectLockRepository.lock(object);
