 ...
 */
public class DnDNewCapsuleProvider extends DnDProvider {

    public DnDNewCapsuleProvider(MoleScene molescene) {
        super(molescene);
    }
...
//    Widget w = UIFactory.getInstance().createCapsule(scene,
