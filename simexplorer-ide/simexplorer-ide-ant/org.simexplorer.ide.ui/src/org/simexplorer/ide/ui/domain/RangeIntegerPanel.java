...
public class RangeIntegerPanel extends EditorPanel<RangeInteger> {
    ...
    public RangeIntegerPanel() {
        super(RangeInteger.class);
        initComponents();
    ...
    @Override
    public void setObjectEdited(RangeInteger range) {
        super.setObjectEdited(range);
        minModel.setValue(Integer.parseInt(range.getInterval().getMin()));
        maxModel.setValue(Integer.parseInt(range.getInterval().getMax()));
        stepModel.setValue(Integer.parseInt(range.getStep()));
    }
    ...
    public String isInputValid() {
        if ((Integer) minModel.getValue() > (Integer) maxModel.getValue()) {
    ...
    private void initComponents() {
        ...
        minSpinner.setModel(new javax.swing.SpinnerNumberModel(Integer.valueOf(1), null, null, Integer.valueOf(1)));

        maxSpinner.setModel(new javax.swing.SpinnerNumberModel(Integer.valueOf(2), null, null, Integer.valueOf(1)));

        stepSpinner.setModel(new javax.swing.SpinnerNumberModel(Integer.valueOf(1), Integer.valueOf(0), null, Integer.valueOf(1)));
