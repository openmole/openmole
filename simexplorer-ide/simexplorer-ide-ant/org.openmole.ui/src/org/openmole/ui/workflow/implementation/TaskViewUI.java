...
import org.openmole.ui.workflow.provider.TaskMoveProvider;
...
public class TaskViewUI extends ObjectViewUI implements ITaskViewUI{
    ...
    public TaskViewUI(MoleScene scene,
        ...
        model = m;
        scene.getManager().registerTaskModel(n,m);
        ...
        getActions().addAction(ActionFactory.createMoveAction(null,new TaskMoveProvider()));
    }
