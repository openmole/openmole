 ...
 * plan = new CompletePlan(builder.exploration.buildFactor(p1, new IntegerRange("1","2","1")),
 *                         builder.exploration.buildFactor(p2, new BigDecimalRange("0.1","0.2","0.1")),
 *                         builder.exploration.buildFactor(p3, new LogarithmDoubleRange("0.001","1","4")))
 *
