...
import org.openmole.plugin.environment.ssh.authentication.SSHAuthentication
...
class SSHEnvironment(login: String, host: String, dir: String, inMemorySizeForRuntime: Option[Int]) extends BatchEnvironment(inMemorySizeForRuntime) {
