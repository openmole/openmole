 ...
 */
public class IterableVariableDomain<T> implements IDomain<T>{

    final IPrototype<Iterable<? extends T>> variable;

    public IterableVariableDomain(IPrototype<Iterable<? extends T>> variable) {
