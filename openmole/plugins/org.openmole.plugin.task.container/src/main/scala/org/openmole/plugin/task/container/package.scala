...
case class SingularityOverlay(reuse: Boolean = true, size: Information = 20.gigabyte, image: Option[_root_.container.Singularity.OverlayImage] = None) extends ContainerSystem:
