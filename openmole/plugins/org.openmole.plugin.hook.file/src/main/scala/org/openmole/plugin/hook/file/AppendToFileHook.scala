...
class AppendToFileHook(moleExecution: IMoleExecution, capsule: ICapsule, fileName: String, content: String) extends CapsuleExecutionHook(moleExecution, capsule) {
