...
import org.openmole.misc.eventdispatcher.IObjectChangedAsynchronousListenerWithArgs;
import org.openmole.misc.eventdispatcher.IObjectChangedListener;
...
import org.openmole.misc.eventdispatcher.IObjectConstructedSynchronousListener;
...
public class EventDispatcher implements IEventDispatcher {
    ...
    public void objectChanged(final Object object, final String type, final Object[] args) throws InternalProcessingError, UserBadDataError {
        ...
        if (objectChangedAsynchronouslisteners.iterator().hasNext() || objectChangedWithTypeAsynchronouslisteners.iterator().hasNext()) {
            ...
            ExecutorService executor = Activator.getExecutorService().getExecutorService(ExecutorType.OWN);
