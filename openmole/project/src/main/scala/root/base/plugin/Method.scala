...
object Method extends PluginDefaults {
  ...
  lazy val evolution = OsgiProject("evolution") dependsOn (Misc.exception, Core.implementation, mgo, Misc.workspace, Hook.file) //todo: other plugins have a dependency on MGO
