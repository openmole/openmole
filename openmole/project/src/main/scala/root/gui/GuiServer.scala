...
object Server extends GuiDefaults {
  ...
  lazy val core = OsgiProject("org.openmole.gui.server.core") settings
    ...
    (Shared.shared, Ext.dataui, Ext.data, Core.workflow, openmoleFile, openmoleTar, openmoleCollection, root.Runtime.console, Misc.utils, root.ThirdParties.openmoleStream, openmoleCrypto)
