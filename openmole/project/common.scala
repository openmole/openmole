...
object common {
  ...
  def scala3VersionValue = "3.5.2"
  def scalajsVersion = "1.17.0"

  def scalaXMLVersion = "2.1.0"
  def gridscaleVersion = "2.54-SNAPSHOT"
  def mgoVersion = "3.60-SNAPSHOT"
  def sshjVersion = "0.38.0"
  def containerVersion = "1.33-SNAPSHOT"
