...
import org.openmole.ide.core.implementation.sampling.{ SamplingCompositionPanelUI, ISamplingComponent }

class DomainMenuProvider(panelScene: SamplingCompositionPanelUI) extends GenericMenuProvider {
