...
object App {
  def main(argvs: Array[String]) = {
    ...
    //    val entry = new java.io.File("/home/mathieu/.openmole/mosqueton/persistent/webui/openmole.js")
    //
    ...
    //    val depsOutput = targetDir / "openmole-webpacked.js"
    //
    //    println("DESPOUT " + depsOutput.getAbsolutePath)
