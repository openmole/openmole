...
class CondorEnvironmentPanelUI(pud: CondorEnvironmentDataUI)(implicit val i18n: ResourceBundle = ResourceBundle.getBundle("help", new Locale("en", "EN"))) extends PluginPanel("fillx,wrap 2", "", "") with EnvironmentPanelUI {
  ...
  override def saveContent(name: String) =
    new CondorEnvironmentDataUI(name,
      loginTextField.text,
      hostTextField.text,
      portTextField.text,
