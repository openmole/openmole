...
class ImageJTaskPanelUI(pud: ImageJTaskDataUI)(implicit val i18n: ResourceBundle = ResourceBundle.getBundle("help", new Locale("en", "EN"))) extends TaskPanelUI {
  ...
  def saveContent(name: String): TaskDataUI = new ImageJTaskDataUI(name,
