...
import org.openmole.core.workflow.job.State.State
import org.openmole.core.workflow.tools.{ ExceptionEvent, IRegistryWithTicket }
...
import org.openmole.core.workflow.job.MoleJobId
