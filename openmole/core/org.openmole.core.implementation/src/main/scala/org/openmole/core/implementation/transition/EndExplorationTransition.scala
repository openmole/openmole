...
class EndExplorationTransition(start: ICapsule, end: Slot, trigger: ICondition, filter: IFilter[String] = Filter.empty) extends Transition(start, end, True, filter) with IEndExplorationTransition {
