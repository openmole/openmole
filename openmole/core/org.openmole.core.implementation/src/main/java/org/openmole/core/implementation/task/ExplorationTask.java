...
public class ExplorationTask extends GenericTask implements IExplorationTask {
    ...
    private ISampling plan;

    public ExplorationTask(String name) throws UserBadDataError, InternalProcessingError {
        super(name);
    }

    public ExplorationTask(String name, ISampling plan) throws UserBadDataError, InternalProcessingError {
        super(name);
        setPlan(plan);
    }
     ...
     */
    @ChangeState
    public void setPlan(ISampling plan) {
        this.plan = plan;
    }
