...
public class Transition extends GenericTransition<ITaskCapsule> implements ITransition {

    public Transition(ITaskCapsule start, ISlot slot, ICondition condition) {
        super(start, slot, condition);
    }

    public Transition(ITaskCapsule start, ISlot slot, String condition) {
        super(start, slot, condition);
    }

    public Transition(ITaskCapsule start, IGenericTaskCapsule end, String condition) {
        super(start, end, condition);
    }

    public Transition(ITaskCapsule start, IGenericTaskCapsule end, ICondition condition) {
        super(start, end, condition);
    }

    public Transition(ITaskCapsule start, IGenericTaskCapsule end) {
        super(start, end);
    }
