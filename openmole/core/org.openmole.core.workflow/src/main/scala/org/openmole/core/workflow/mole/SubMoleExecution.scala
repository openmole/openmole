      ...
      capsule match {
        case c: MasterCapsule ⇒
          ...
          masterCapsuleExecutor.submit {
            ...
            moleJob.perform(TaskExecutionContext(newFile.baseDir, moleExecution.defaultEnvironment, preference, threadProvider, fileService, workspace, moleExecution.taskCache))
