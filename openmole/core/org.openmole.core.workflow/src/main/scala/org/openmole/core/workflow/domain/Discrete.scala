...
object DiscreteFromContext {

  implicit def discreteIsContextDiscrete[D, T](implicit d: Discrete[D, T]): DiscreteFromContext[D, T] =
    new DiscreteFromContext[D, T] {
