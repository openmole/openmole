...
object JSPages {
  ...
  lazy val documentation_language_methods_calibration = JSDocumentationPage("Calibration", "Documentation_Language_Methods_Calibration.html", details = Seq(documentation_language_methods_geneticalgo, documentation_language_methods_island, documentation_language_methods_stochasticity))
  ...
  lazy val documentation_language_methods_geneticalgo = JSDocumentationPage("Genetic Algorithms", "Documentation_Language_Methods_geneticalgo.html")
  lazy val documentation_language_methods_island = JSDocumentationPage("Islands Scheme", "Documentation_Language_Methods_island.html")
  lazy val documentation_language_methods_stochasticity = JSDocumentationPage("Stochasticity Management", "Documentation_Language_Methods_stochasticity.html")
