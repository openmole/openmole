...
object module {
  ...
  def allModules =
    Seq[ModuleEntry](
      ...
      ModuleEntry("Dispatch", "Dispatch workload on multiple environments", components(org.openmole.plugin.environment.dispatch.DispatchEnvironment), environment),
      ...
      ModuleEntry("SpatialSampling", "Generate spatial samplings", components(org.openmole.plugin.task.spatial.SpatialSampling), sampling),
