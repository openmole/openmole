...
val clientPrivatePackages = Seq("com.raquo.*", "org.scalajs.dom.*", "scaladget.*", "net.scalapro.sortable.*", "org.openmole.plotlyjs.*", "org.querki.jsext.*", /*"scala.collection.compat.*",*/ "app.tulz.tuplez.*", /*"shapeless3.*",*/ "scala.deriving.*")
