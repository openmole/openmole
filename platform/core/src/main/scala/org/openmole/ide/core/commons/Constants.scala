...
object Constants{
  ...
  val PROTOTYPE_DATA_FLAVOR= new DataFlavor(classOf[PrototypeUI], Constants.PROTOTYPE)
  val TASK_DATA_FLAVOR= new DataFlavor(classOf[TaskUI], Constants.TASK)
  val SAMPLING_DATA_FLAVOR= new DataFlavor(classOf[SamplingUI], Constants.SAMPLING)
  val PROTOTYPE_MODEL_DATA_FLAVOR= new DataFlavor(classOf[PaletteElementFactory], "PrototypeModel")
  val TASK_MODEL_DATA_FLAVOR= new DataFlavor(classOf[PaletteElementFactory], "TaskModel")
  val SAMPLING_MODEL_DATA_FLAVOR= new DataFlavor(classOf[PaletteElementFactory], "SamplingModel")
