...
@ActionRegistration(displayName = "#CTL_EnvironmentsAction")
@ActionReferences({
    @ActionReference(path = "Toolbars/File", position = 260)
})
@Messages("CTL_EnvironmentsAction=Environments")
public class EnvironmentsAction extends AbstractAction implements Presenter.Toolbar {
