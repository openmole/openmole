...
id = "org.openmole.ide.core.implementation.toolbar.TasksAction")
@ActionRegistration(displayName = "#CTL_TasksAction")
@ActionReferences({
    @ActionReference(path = "Toolbars/File", position = 220)
})
@Messages("CTL_TasksAction=Tasks")
public class TasksAction extends AbstractAction implements Presenter.Toolbar {
